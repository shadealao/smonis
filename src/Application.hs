...
import Handler.StoreSession
import Handler.User
import Handler.EditUser
import Handler.CreateUser
import Handler.Creneaux
import Handler.Cours
import Handler.CoursEnseignant
import Handler.Produit
import Handler.Tarif
import Handler.Panier
--import Handler.DashboardStat
...
makeFoundation appSettings = do
    ...
    createDirectoryIfMissing False uploadDirectory
    _ <- static uploadDirectory
    -- static@(Static _) <- static uploadDirectory
    ...
    -- TODO MBJ : IF THE MIGRATION DOES NOT WORK ANYMORE because TO MUCH CHANGES ON THE MODEL, WE JUST PRINT MIGRATION INSTEAD
